# TanStack DB Patterns (Collections)

Patterns for TanStack DB collections, live queries, and optimistic mutations. For vanilla TanStack Query (queries, mutations, prefetching, SSR) see `query-patterns.md`.

## Contents

- Core Architecture
- Critical Rules (5 — read all before writing collection code)
...
- Collection Setup
- Live Query Patterns (basic, joins)
- Optimistic Updates
- Testing
- Common Anti-Patterns
- Advanced Patterns (computed collections, aggregations, pagination)
...
Before finishing a task involving TanStack DB:
